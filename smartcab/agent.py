...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing == False:
            ...
            #self.decay = math.pow(self.alpha,self.trial)
    ...
    def createQ(self, state):
        ...
        action = {}
        for action_item in self.valid_actions:
    ...
    def choose_action(self, state):
        ...
        if self.learning == False:
            all_action.append(random.choice(self.valid_actions))
        if self.learning == True:
            if self.epsilon > random.random():
                ...
                for item in self.Q[state]:
                    if self.Q[state][item] == maxVal:
                        all_action.append(item)
    ...
    def learn(self, state, action, reward):
        ...
        if self.learning == True:
            self.Q[state][action] =  ((1.0 - int(self.alpha))*(self.Q[state][action])) + (self.alpha*reward)
...
def run():
    ...
    agent = env.create_agent(LearningAgent, learning = True, alpha = 0.0099)
